...
const { initSchema, getKey, setKey, delKey, listKeys, registerTrial, addFeedback, listFeedback } =
  ...
  try {
    ...
    if (url.pathname === '/api/feedback') {
      if (req.method === 'POST') {
        ...
        return sendJson(res, 200, await addFeedback(b));
      }
      if (req.method === 'GET') return sendJson(res, 200, { items: await listFeedback() });
    }
